...
const dict = {
  ...
  'connect-none': { zh: '远程连接不可用。', en: 'Remote connection is unavailable.' },
  'remote-endpoint-question': { zh: 'dsh Web 地址', en: 'dsh Web endpoint' },
  'remote-endpoint-detail': { zh: '仅接受 HTTPS，例如 https://chat.example.com', en: 'HTTPS only, for example https://chat.example.com' },
  'remote-email-question': { zh: '登录邮箱', en: 'Login email' },
  'remote-password-question': { zh: '登录密码（输入已遮罩）', en: 'Password (input is masked)' },
  'remote-login-invalid': { zh: '邮箱或密码不能为空。', en: 'Email and password are required.' },
  'remote-connected': { zh: '已连接 dsh Web。', en: 'Connected to dsh Web.' },
  'remote-action-question': { zh: '选择远程操作', en: 'Choose a remote action' },
  'remote-action-overview': { zh: '查看概览', en: 'Overview' },
  'remote-action-session': { zh: '会话管理', en: 'Sessions' },
  'remote-action-workspace': { zh: '云端工作区', en: 'Cloud workspaces' },
  'remote-action-model': { zh: '模型选择', en: 'Select model' },
  'remote-action-mode': { zh: '模式选择', en: 'Select mode' },
  'remote-action-local-workspace': { zh: '本地化工作区', en: 'Local workspace' },
  'remote-action-refresh': { zh: '刷新', en: 'Refresh' },
  'remote-action-logout': { zh: '退出远程登录', en: 'Sign out' },
  'remote-action-done': { zh: '完成', en: 'Done' },
  'remote-overview-account': { zh: '账户：{{name}}（{{role}}）', en: 'Account: {{name}} ({{role}})' },
  'remote-overview-quota': { zh: '额度：{{amount}}', en: 'Quota: {{amount}}' },
  'remote-overview-counts': { zh: '模型 {{models}} · 会话 {{sessions}} · 工作区 {{workspaces}}', en: '{{models}} models · {{sessions}} sessions · {{workspaces}} workspaces' },
  'remote-overview-active': { zh: '当前：{{session}} · {{workspace}}', en: 'Active: {{session}} · {{workspace}}' },
  'remote-none': { zh: '无', en: 'none' },
  'remote-session-question': { zh: '选择或创建远程会话', en: 'Select or create a remote session' },
  'remote-session-new': { zh: '＋ 新建会话', en: '+ New session' },
  'remote-session-cancel': { zh: '× 取消当前会话', en: '× Cancel active session' },
  'remote-session-title-question': { zh: '新会话名称', en: 'New session title' },
  'remote-session-selected': { zh: '远程会话已选择：{{name}}', en: 'Remote session selected: {{name}}' },
  'remote-workspace-question': { zh: '选择或创建云端工作区', en: 'Select or create a cloud workspace' },
  'remote-workspace-new': { zh: '＋ 从当前会话目录创建工作区', en: '+ Create from active session directory' },
  'remote-workspace-delete': { zh: '× 删除当前工作区', en: '× Delete active workspace' },
  'remote-workspace-title-question': { zh: '新工作区名称（可自定义）', en: 'New workspace name' },
  'remote-workspace-selected': { zh: '云端工作区已选择：{{name}}', en: 'Cloud workspace selected: {{name}}' },
  'remote-model-question': { zh: '选择远程模型', en: 'Select a remote model' },
  'remote-model-selected': { zh: '远程模型已选择：{{name}}', en: 'Remote model selected: {{name}}' },
  'remote-mode-question': { zh: '选择要设置的模式', en: 'Choose a mode category' },
  'remote-mode-agent': { zh: 'Agent 预设', en: 'Agent preset' },
  'remote-mode-permission': { zh: '权限预设', en: 'Permission preset' },
  'remote-mode-plan-on': { zh: '开启计划模式', en: 'Enable plan mode' },
  'remote-mode-plan-off': { zh: '关闭计划模式', en: 'Disable plan mode' },
  'remote-mode-selected': { zh: '远程模式已更新：{{name}}', en: 'Remote mode updated: {{name}}' },
  'remote-local-question': { zh: '选择本地工作区操作', en: 'Choose a local workspace action' },
  'remote-local-bind': { zh: '绑定本机目录', en: 'Bind a local directory' },
  'remote-local-unbind': { zh: '解除本机目录', en: 'Unbind local directory' },
  'remote-local-path-question': { zh: '本机目录绝对路径', en: 'Absolute local directory path' },
  'remote-local-bound': { zh: '本地化工作区已连接：{{name}}', en: 'Local workspace connected: {{name}}' },
  'remote-local-unbound': { zh: '本地化工作区已解除。', en: 'Local workspace unbound.' },
  'remote-logged-out': { zh: '已退出远程登录，本地 Cookie 已清除。', en: 'Signed out and cleared the local session cookie.' },
  'remote-operation-failed': { zh: '远程操作失败：{{code}}', en: 'Remote operation failed: {{code}}' },
  'remote-status-connecting': { zh: '☁ 连接中 · {{endpoint}}', en: '☁ Connecting · {{endpoint}}' },
  'remote-status-login': { zh: '☁ 待登录 · {{endpoint}}', en: '☁ Sign-in required · {{endpoint}}' },
  'remote-status-ready': { zh: '☁ {{endpoint}} · {{user}} · 额度 {{quota}} · {{session}}', en: '☁ {{endpoint}} · {{user}} · quota {{quota}} · {{session}}' },
  'remote-status-error': { zh: '☁ {{endpoint}} · {{code}}', en: '☁ {{endpoint}} · {{code}}' },
  ...
  'cmd-desc-connect': { zh: '登录 dsh Web 并管理云端会话、模型、模式与工作区' },
